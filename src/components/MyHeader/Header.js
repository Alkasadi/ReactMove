...
export default function Header() {
  ...
  <img src={logen} alt="dfd" width="60px" className="logen" />
    ...
    <form class="d-flex" role="search">
      <a href='http://localhost:3000/ReactMove' class=" button-fl">تسجيل /تسجيل الذخول
      </a>
      ...
      <div class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="http://localhost:3000/MyHeader">مسلسلات رمضان 2020</a></li>
            <li><a class="dropdown-item" href="http://localhost:3000/MyHeader">مسلسلات رمضان 2021</a></li>
            <li><a class="dropdown-item" href="http://localhost:3000/MyHeader">مسلسلات رمضان 2022</a></li>
...
افلام          </a>
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="http://localhost:3000/Myboody">فلام عربي</a></li>
            <li><a class="dropdown-item" href="http://localhost:3000/Myboody">فلام تركي</a></li>
            <li><a class="dropdown-item" href="http://localhost:3000/Myboody#">فلام اجنبي</a></li>
          </ul>
        </li>
